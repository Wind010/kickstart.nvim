...
vim.api.nvim_set_keymap('v', 'df', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('i', 'df', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('c', 'df', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('t', 'df', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('n', 'fd', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('v', 'fd', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('i', 'fd', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('c', 'fd', '<Esc>', { noremap = true })
vim.api.nvim_set_keymap('t', 'fd', '<Esc>', { noremap = true })
